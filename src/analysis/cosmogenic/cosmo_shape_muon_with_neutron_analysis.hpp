#ifndef ANALYSIS_COSMO_SHAPE_MUON_WITH_NEUTRON_ANALYSIS_HPP_
#define ANALYSIS_COSMO_SHAPE_MUON_WITH_NEUTRON_ANALYSIS_HPP_
...
class cosmo_shape_muon_with_neutron_analysis : public cosmo_shape_muon_analysis {

public:

    using cosmo_shape_muon_analysis::cosmo_shape_muon_analysis;

    ~cosmo_shape_muon_with_neutron_analysis() override = default;
...
#endif // ANALYSIS_COSMO_SHAPE_MUON_WITH_NEUTRON_ANALYSIS_HPP_