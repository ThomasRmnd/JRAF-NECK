#ifndef JRAFNECK_ANALYSIS_MUON_RATE_MUONRATELSMUONANALYSIS_HPP_
#define JRAFNECK_ANALYSIS_MUON_RATE_MUONRATELSMUONANALYSIS_HPP_

#include "analysis/muon/rate/muon_rate_analysis.hpp"

class muon_rate_ls_muon_analysis : public muon_rate_analysis {

public:

    using muon_rate_analysis::muon_rate_analysis;

    ~muon_rate_ls_muon_analysis() override = default;
...
#endif // JRAFNECK_ANALYSIS_MUON_RATE_MUONRATELSMUONANALYSIS_HPP_